...
class Multimedia { 
     public $id_datas, $chemin_relatif, $name_origin, $mime_type, $description ,$auteur_id, $date;
...
*/
    ...
    static public function getMimeAllowed():string
    {
        $resultat = "";
...
<!--Mask color-->
<div class="view">
  <img class="d-block w-100 imagecarousel" src="%s" alt="%s">
  <div class="mask rgba-black-strong"></div>
</div>
<div class="carousel-caption">
  <h3 class="h3-responsive">%s</h3>
</div>
</div>
*/